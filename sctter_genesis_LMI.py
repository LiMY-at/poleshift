...
# file_nc = {"CMCC-CM2-HR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/HR/TC-NH_TRACK_CMCC-CM2-VHR4_highresSST-present_r1i1p1f1_gn_19500101-20141231.nc",
#         "CMCC-CM2-LR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LR/TC-NH_TRACK_CMCC-CM2-HR4_highresSST-present_r1i1p1f1_gn_19500101-20141231.nc",
#         "HadGEM3-GC31-HR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/HR/TC-NH_TRACK_HadGEM3-GC31-HM_highresSST-present_r1i1p1f1_gn_19500101-20141231.nc",
#         "HadGEM3-GC31-LR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LR/TC-NH_TRACK_HadGEM3-GC31-LM_highresSST-present_r1i1p1f1_gn_19500101-20141231.nc",
#         "CNRM-CM6-1-HR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/MR/TC-NH_TRACK_CNRM-CM6-1-HR_highresSST-present_r1i1p1f2_gr_19500101-20141231.nc",
#         "CNRM-CM6-1-LR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LR/TC-NH_TRACK_CNRM-CM6-1_highresSST-present_r1i1p1f2_gr_19500101-20141231.nc"}


#file_nc = {"CMCC-CM2-HR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CMCC-CM2/HR/1950-2014/TC-NH_TRACK_CMCC-CM2-VHR4_hist-1950_r1i1p1f1_gn_19500101-20141231.nc",
#        "CMCC-CM2-LR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CMCC-CM2/LR/1950-2014/TC-NH_TRACK_CMCC-CM2-HR4_hist-1950_r1i1p1f1_gn_19500101-20141231.nc",
#        "HadGEM3-GC31-HR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/HadGEM/HR/1950-2014/TC-NH_TRACK_HadGEM3-GC31-HM_hist-1950_r1i1p1f1_gn_19500101-20141231.nc",
#        "HadGEM3-GC31-LR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/HadGEM/LR/1950-2014/TC-NH_TRACK_HadGEM3-GC31-MM_hist-1950_r1i1p1f1_gn_19500101-20141231.nc",
#        "CNRM-CM6-1-HR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CNRM/HR/1950-2014/TC-NH_TRACK_CNRM-CM6-1-HR_hist-1950_r1i1p1f2_gr_19500101-20141231.nc",
#        "CNRM-CM6-1-LR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CNRM/LR/1950-2014/TC-NH_TRACK_CNRM-CM6-1_hist-1950_r1i1p1f2_gr_19500101-20141231.nc"}
...
for run in list(file_nc.keys()):
    ...
    start_lat[run] = np.array(start_lat[run])
...
#ax.set_xticklabels(list(map(lambda x:str(x)+"˚N",xticks)))
ax.set_yticks(yticks)
ax.set_yticklabels(list(map(lambda x:str(x)+"˚N",yticks)))

# label
ax.set_xlabel(r"Max.lifetime 10m wind speed ($m·s^{-1}$)",fontsize=14)
ax.set_ylabel(r"$\varphi_{Genesis}$",fontsize=18)
# lim
ax.set_ylim(0,30)
# 题目
#ax.set_title(title,fontsize=15,loc="center")
ax.set_title(f"Coupled",fontsize=18,loc="center")
# grid
ax.grid(True)
ax.legend(fontsize=12)
fig.savefig("CMCC-COU-Ge_wind.png",dpi=300)
...
fig2,ax2 = plt.subplots(1,1,figsize=(7,8))
# 线型
ls = {"CM-CH":"-",
      "Had-CH":"-",
      "CN-CH":"-",
...
for run in list(mslp_lat.keys()):
    ...
    y = mslp_lat[run][ind]
    # 散点绘制
    ax2.scatter(x,y,s=5,marker = marker[run],color=lc[run],alpha=0.5)
    # 多项式拟合
    z = np.polyfit(x, y, 3)
    p = np.poly1d(z)
    # 确定范围
    xp = np.linspace(x.min(),x.max(),20)
    # 绘制拟合曲线
    ax2.plot(xp,p(xp),label=run,ls = ls[run],color=lc[run],linewidth=2.5,alpha=0.8)
    # 绘制置信区间
    n = len(x)
    yfit = p(x)
    resid = yfit-y
    ...
    t = stats.t.ppf(0.975, n - 2)
    ci = t * s_err * np.sqrt(    1/n + (x - np.mean(x))**2/np.sum((x-np.mean(x))**2))
    ax2.fill_between(x, yfit+ci, yfit-ci,color=lc[run], edgecolor='k',alpha=0.3) 
...
ax2.set_xticklabels(list(map(lambda x:str(x)+"˚N",xticks)))
ax2.set_yticks(yticks)
ax2.set_yticklabels(list(map(lambda x:str(x)+"˚N",yticks)))
# label
ax2.set_xlabel(r"$\varphi_{Genesis}$",fontsize=14)
ax2.set_ylabel(r"$\varphi_{LMI}$",fontsize=18)
# lim
ax2.set_ylim(0,50)
ax2.set_xlim(0,30)
# 题目
#ax.set_title(title,fontsize=15,loc="center")
ax2.set_title(f"Coupled",fontsize=18,loc="center")
# grid
ax2.grid(True)
ax2.legend(fontsize=12)
fig2.savefig("CMCC-COU-LMI_Ge.png",dpi=300)
