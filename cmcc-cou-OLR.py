...
file_L = {"p1":'/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CMCC-CM2/LR/2015-2050/TC-NH_TRACK_CMCC-CM2-HR4_highres-future_r1i1p1f1_gn_20150101-20501231.nc',
           "p2":'/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CMCC-CM2/LR/1950-2014/TC-NH_TRACK_CMCC-CM2-HR4_hist-1950_r1i1p1f1_gn_19500101-20141231.nc'}

phi1979_7, phi1979_10, phi2015_7, phi2015_10, phi1979_2050_L, start_lat_L = LHresolution(file_L)

file_H = {"p1":'/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CMCC-CM2/HR/2015-2050/TC-NH_TRACK_CMCC-CM2-VHR4_highres-future_r1i1p1f1_gn_20150101-20501231.nc',
           "p2":'/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CMCC-CM2/HR/1950-2014/TC-NH_TRACK_CMCC-CM2-VHR4_hist-1950_r1i1p1f1_gn_19500101-20141231.nc'}
...
gl0=xr.open_dataset('/icar/chaoxia2684/data/HisResMIP_chazhi/zg_hist-1950/1x1_zg_Amon_CMCC-CM2-HR4_hist-1950_r1i1p1f1_gn.nc').zg.sel(plev=50000)
gl1=xr.open_dataset('/icar/chaoxia2684/data/HisResMIP_chazhi/zg_highres-future/1x1_zg_Amon_CMCC-CM2-HR4_highres-future_r1i1p1f1_gn.nc').zg.sel(plev=50000)
...
gh0=xr.open_dataset('/icar/chaoxia2684/data/HisResMIP_chazhi/zg_hist-1950/1x1_zg_Amon_CMCC-CM2-VHR4_hist-1950_r1i1p1f1_gn.nc').zg.sel(plev=50000)
gh1=xr.open_dataset('/icar/chaoxia2684/data/HisResMIP_chazhi/zg_highres-future/1x1_zg_Amon_CMCC-CM2-VHR4_highres-future_r1i1p1f1_gn.nc').zg.sel(plev=50000)
...
file_nc1979 = {"CMCC-CM2-HR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CMCC-CM2/HR/1950-2014/TC-NH_TRACK_CMCC-CM2-VHR4_hist-1950_r1i1p1f1_gn_19500101-20141231.nc",
...
file_nc2015 = {"CMCC-CM2-HR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CMCC-CM2/HR/2015-2050/TC-NH_TRACK_CMCC-CM2-VHR4_highres-future_r1i1p1f1_gn_20150101-20501231.nc",
        "CMCC-CM2-LR":"/nuist/scratch/chaoxia2684/limy/python_code/HRtrack/LMI_season/model/Coupled/CMCC-CM2/LR/2015-2050/TC-NH_TRACK_CMCC-CM2-HR4_highres-future_r1i1p1f1_gn_20150101-20501231.nc"
        }
...
vl0=xr.open_dataset('/icar/chaoxia2684/data/HisResMIP_chazhi/va_hist-1950/1x1_va_Amon_CMCC-CM2-HR4_hist-1950_r1i1p1f1_gn.nc').va
vl1=xr.open_dataset('/icar/chaoxia2684/data/HisResMIP_chazhi/va_highres-future/1x1_va_Amon_CMCC-CM2-HR4_highres-future_r1i1p1f1_gn.nc').va
...
vh0=xr.open_dataset('/icar/chaoxia2684/data/HisResMIP_chazhi/va_hist-1950/1x1_va_Amon_CMCC-CM2-VHR4_hist-1950_r1i1p1f1_gn.nc').va
vh1=xr.open_dataset('/icar/chaoxia2684/data/HisResMIP_chazhi/va_highres-future/1x1_va_Amon_CMCC-CM2-VHR4_highres-future_r1i1p1f1_gn.nc').va
...
#标趋势的值
ax.text(1984,30, str(round(trend_LMI,2)) +'° $decade^{-1}$', fontdict={'color':'black'})
ax.text(1984,28, str(round((aa*trend_LAT0+bb*trend_WND+cc*trend_ratio+dd*trend_v+ee*trend_sf+ff*trend_index),2)) +'° $decade^{-1}$', fontdict={'color':'red'})
